...
def cal_kl(err_info_dic_1, est_card_1, raw_card_1,
    ...
    for i in dim:
        ...
        density_1 = np.exp(
            pdf_after_bin_1.score_samples(err_sample_1.reshape(-1, 1)))  # probability correspond to this sample
        ...
        if debug:
            ...
            print(
                f"est_card_ori: {est_card_1[i]}, table_size: {raw_card_1[i]}, est_card_new: {est_card_2[i]}, table_size: {raw_card_2[i]}")
