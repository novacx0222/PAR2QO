...
def querylet(db, kk, cc, template_name, split=None, instance=None):
    ...
    querylet_dsb_dict = {
        ...
        'template_store_sales_item_both': f"select * from store_sales, item where {cc} and {kk} and ss_item_sk = i_item_sk;",
        # single table
        'template_store_sales': f"select * from  store_sales where {cc};",
        'template_customer_demographics': f"select * from customer_demographics where {cc};",
        'template_household_demographics': f"select * from household_demographics where {cc};",
        'template_customer_address': f"select * from customer_address where {cc};",
        'template_date_dim': f"select * from date_dim where {cc};",
        'template_catalog_sales': f"select * from catalog_sales where {cc};",
        'template_customer': f"select * from customer where {cc};",
        'template_item': f"select * from item where {cc};",
        'template_income_band': f"select * from income_band where {cc};",
        'template_web_sales': f"select * from web_sales where {cc};",
        'template_warehouse': f"select * from warehouse where {cc};",
        'template_ship_mode': f"select * from ship_mode where {cc};",
        ...
        'template_inventory_full': f"select * from inventory;",
        'template_customer_full': f"select * from customer;",
        'template_household_demographics_full': f"select * from household_demographics;",
        'template_web_returns_full': f"select * from web_returns;",
        'template_web_page_full': f"select * from web_page;",
        'template_catalog_returns_full': f"select * from catalog_returns;"
    }
    ...
    if db == 'imdb':
        if split is None:
            ...
            if template_name in querylet_imdb_dict.keys():
                return querylet_imdb_rob_dict[template_name]
            else:
                return None
    elif db == 'dsb':
