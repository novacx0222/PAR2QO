...
SOURCE_ROOT="${SOURCE_ROOT:-/opt/sqls/imdb-separate-ep-0826}"
REFERENCE_ROOT="${REFERENCE_ROOT:-/opt/sqls/imdb-error-profile-0612}"
OUTPUT_PREFIX="${OUTPUT_PREFIX:-/opt/sqls/imdb-separate-ep-0826}"
